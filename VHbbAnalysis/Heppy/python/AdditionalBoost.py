...
class AdditionalBoost( Analyzer ):
    ...
    def declareHandles(self):
        ...
        self.handles['ak08']     = AutoHandle( ("slimmedJetsAK8","","RECO"), "std::vector<pat::Jet>")
        ...
        self.handles['ak08softdropsubjets'] = AutoHandle( ("slimmedJetsAK8PFCHSSoftDropPacked","SubJets","RECO"), "std::vector<pat::Jet>")
